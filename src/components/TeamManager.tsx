...
export default function TeamManager({ isOpen, onClose }: TeamManagerProps) {
  ...
  const handleViewMembers = (teamId: string) => {
    // This will be handled by opening TeamMembers modal
    setSelectedTeam(teamId)
    onClose() // Close this modal
    // Parent component will handle opening TeamMembers modal
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        <div className="modal-header">
          <h2 className="modal-title">Company Teams</h2>
